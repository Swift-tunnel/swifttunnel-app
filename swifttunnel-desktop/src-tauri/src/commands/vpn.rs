...
fn map_vpn_state(conn_state: swifttunnel_core::vpn::ConnectionState) -> VpnStateResponse {
    match conn_state {
        ...
        swifttunnel_core::vpn::ConnectionState::CreatingAdapter => VpnStateResponse {
            state: "creating_adapter".to_string(),
            region: None,
            server_endpoint: None,
            assigned_ip: None,
            split_tunnel_active: false,
        ...
        swifttunnel_core::vpn::ConnectionState::Connecting => VpnStateResponse {
        ...
        swifttunnel_core::vpn::ConnectionState::ConfiguringRoutes => VpnStateResponse {
            state: "configuring_routes".to_string(),
            region: None,
            server_endpoint: None,
            assigned_ip: None,
            split_tunnel_active: false,
